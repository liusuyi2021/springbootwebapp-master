package org.synjones.springframework.server;
...
import org.synjones.springframework.util.GetBeanUtil;
...
public class NanoHTTPd { 
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files) {
       ...
       /* while (e.hasMoreElements()) {
        ...
        while (e.hasMoreElements()) {
            ...
            //System.out.println("22PRM: '" + value + "' = '" + parms.getProperty(value) + "'");
           // String values =parms.getProperty(value).replaceAll("\r|\n","");
            String tempStr=value+parms.getProperty(value);
            //System.out.println(tempStr);
       /*     String body = tempStr;//.replaceAll("\n", "").replaceAll("\r", "");
            JSONObject json; 
			//	System.out.println(values);
				json = JSONObject.parseObject(body);
	            System.out.println("设备ID"+json.get("ID"));//****
	            System.out.println(json.get("drivers"));
	            //System.out.println(json.get("src")); 
	            JSONObject srcjson = JSONObject.parseObject(json.getString("src"));
	            
	            System.out.println("faceid"+srcjson.get("faceid")); //****
	            
	            System.out.println(srcjson.get("TEMP")); //****
	            System.out.println(srcjson.get("name")); //****
	            System.out.println(srcjson.get("id")); 
	            System.out.println(srcjson.get("type")); 
	            System.out.println(srcjson.get("record_time")); //***
	       */    // GetBeanUtil.newProduct(srcjson.getString("faceid"),srcjson.getString("name"),srcjson.getString("image"),srcjson.getString("TEMP"),srcjson.getString("record_time"),json.getString("ID"));
	            /*
	            Product mug = new Product();
	            mug.setDescription("Spring Framework Guru Mug");
	            mug.setImageUrl("https://springframework.guru/wp-content/uploads/2015/04/spring_framework_guru_coffee_mug-r11e7694903c348e1a667dfd2f1474d95_x7j54_8byvr_512.jpg");
	            mug.setProductId("0011");
	            mug.setPrice(new BigDecimal("11.95"));
	            productServiceImpl.saveProduct(mug);*/
			   /*
            JSONObject aaa= JSON.parseObject(body); 
        ...
        return new Response(HTTP_OK, MIME_HTML, "{ \"code\": 1, \"msg\": \"success\", \"data\":0 }");
     ...
     */
    public NanoHTTPd(int port,Boolean isOnlyOpen) throws IOException {
        myTcpPort = port;
    ...
    private class HTTPSession implements Runnable {
        ...
        public void run() {
            try {
                ...
                ZxtData zxtData;
                try{
                    zxtData= JSON.parseObject(fbuf,ZxtData.class); 
                    if(zxtData==null){
            			String s = new String(fbuf);
            			System.out.println("丢弃 0" +s);
            		}
                    GetBeanUtil.newProduct(zxtData);
                   // GetBeanUtil.newProduct(srcjson.getString("faceid"),srcjson.getString("name"),srcjson.getString("image"),srcjson.getString("TEMP"),srcjson.getString("record_time"),json.getString("ID"));
        	        System.out.println(zxtData.getSrc().getRecord_time());
                }catch (Exception e1){
                    e1.printStackTrace();
